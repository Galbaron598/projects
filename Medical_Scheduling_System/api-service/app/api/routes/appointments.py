    ...
    try:
        with get_db() as conn:
            with conn.cursor() as cursor:
                ...
                return repo.get_appointments(cursor, patient_id, status_filter, limit, offset)
...
async def get_upcoming_appointments(
    ...
    try:
        with get_db() as conn:
            with conn.cursor() as cursor:
                repo = AppointmentRepository()
                return repo.get_upcoming_appointments(cursor, patient_id, limit)
...
async def get_past_appointments(
    ...
    try:
        with get_db() as conn:
            with conn.cursor() as cursor:
                repo = AppointmentRepository()
                return repo.get_past_appointments(cursor, patient_id, limit, offset)
...
async def get_appointment(
    ...
    try:
        with get_db() as conn:
            with conn.cursor() as cursor:
                repo = AppointmentRepository()
                appointment = repo.get_appointment_by_id(cursor, appointment_id, patient_id)
...
async def delete_appointment(
    ...
    try:
        with get_db() as conn:
            with conn.cursor() as cursor:
                service = AppointmentService()
                service.cancel_appointment(cursor, appointment_id)
                return None
