...
def test_get_appointments_empty(client, auth_headers, clean_db):
...
def test_get_appointments(client, auth_headers, sample_appointment):
...
def test_get_upcoming_appointments(client, auth_headers, sample_appointment):
    """Test getting upcoming appointments only"""
    response = client.get("/api/appointments/upcoming", headers=auth_headers)
...
def test_get_appointment_stats(client, auth_headers, sample_appointment):
    """Test getting appointment statistics"""
    response = client.get("/api/appointments/stats", headers=auth_headers)
...
def test_create_appointment(client, auth_headers, sample_doctor, sample_medical_field):
...
def test_create_appointment_conflict(client, auth_headers, sample_appointment, 
...
def test_create_appointment_past_time(client, auth_headers, sample_doctor, sample_medical_field):
...
def test_update_appointment(client, auth_headers, sample_appointment):
...
def test_cancel_appointment(client, auth_headers, sample_appointment):
...
def test_delete_appointment(client, auth_headers, sample_appointment):
